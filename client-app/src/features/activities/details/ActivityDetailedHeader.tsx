      ...
      <Segment.Group>
        <Segment basic attached="top" style={{ padding: "0" }}>
          {activity.isCancelled && (
            <Label style={{position: 'absolute', zIndex: 1000, left:-4, top:20}} ribbon color='red' content='Cancelled'/>
          )}
          <Image
        ...
        <Segment clearing attached="bottom">
          {activity.isHost ? (
            <>
              ...
              <Button  as={Link} to={`/manage/${activity.id}`} disabled={activity.isCancelled}
